...
WEBHOOK_URL = os.getenv("WEBHOOK_URL")  # مثال: https://my-telegram-bot-xxxxx.onrender.com/webhook

bot = telebot.TeleBot(API_TOKEN)
app = Flask(__name__)

user_photo_quota = {}  # لتتبع عدد الصور لكل مستخدم
student_lookup = {}    # لتتبع الصور المربوطة بالطلاب
